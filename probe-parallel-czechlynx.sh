...
LOMA_CUSTOM_CHECKPOINT_PATH="${LOMA_CUSTOM_CHECKPOINT_PATH:-${CHECKPOINT_ROOT}/loma-b-finetuned-trainval-4gpu/epoch_${CHECKPOINT_EPOCH}/model.safetensors}"
RDD_CUSTOM_CHECKPOINT_PATH="${RDD_CUSTOM_CHECKPOINT_PATH:-${CHECKPOINT_ROOT}/rdd-finetuned-legacy-rdd-mined/epoch_${CHECKPOINT_EPOCH}/model.safetensors}"
